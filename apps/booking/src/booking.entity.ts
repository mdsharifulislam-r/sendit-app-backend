...
export class Booking {
  ...
  @Prop({ type: Object, default: {} })
  dropoff_condition: { proof_image: string, package_condition: string, damage_image: string, note: string, recipient_signature_type: string, reciept_signature: string }
